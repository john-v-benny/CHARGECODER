...
import loginButtonImage from './assets/login_signup.png';
...
const App = () => {
  ...
  return (
    <div className="app" onMouseMove={handleMouseMove}>
      ...
      <button className="login-btn" onClick={() => console.log('Navigating to Login/Sign Up...')}>
